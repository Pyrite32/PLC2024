...
class HW1TestSolutions {
    ...
    void test3() throws PLCCompilerException {
        assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
            String input = """
                    ...
                    """;
            AST ast = getAST(input);
            checkStringLitExpr(ast, "hellothere");
        });
    ...
    void test6() throws PLCCompilerException {
        assertTimeoutPreemptively(Duration.ofMillis(88888888), () -> {
            String input = """
                    ? a -> b , c
    ...
    void test7() throws PLCCompilerException {
        assertTimeoutPreemptively(Duration.ofMillis(8888888), () -> {
            String input = """
                    a | b
    ...
    void test13() throws PLCCompilerException {
        assertTimeoutPreemptively(Duration.ofMillis(66666666), () -> {
            String input = """
                    [a, b, c]
    ...
    void test14() throws PLCCompilerException {
        assertTimeoutPreemptively(Duration.ofMillis(6666666), () -> {
            String input = """
                    (a+b)[2+2, 3+3]:green
    ...
    void test18() throws PLCCompilerException {
        assertTimeoutPreemptively(Duration.ofMillis(TIMEOUT_MILLIS), () -> {
            ...
            checkStringLitExpr(v5, "weirdexpression");
        });
